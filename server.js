  ...
  try {
    ...
    await sendEmail({
      ...
      html: `
        ...
        <p>Your registration for <b>ISTE INDUSTRY 5.0</b> has been <b>APPROVED</b>.</p>
        <p><b>Transaction ID:</b> ${registration.transactionId}</p>
        <p><b>Total Amount:</b> ₹${registration.totalAmount}</p>
        <br/>
...
app.put('/api/admin/registration/:id/reject', authenticateToken, async (req, res) => {
  try {
    ...
    await sendEmail({
      to: registration.email,
      subject: '❌ Registration Rejected – ISTE INDUSTRY 5.0',
      html: `
        <h2>Hello ${registration.fullName},</h2>
        <p>Your registration for <b>ISTE INDUSTRY 5.0</b> has been <b>REJECTED</b>.</p>
        <p><b>Reason:</b> ${registration.rejectionReason}</p>
        <br/>
